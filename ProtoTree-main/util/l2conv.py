...
class L2Conv3D(nn.Module):
    ...
    def __init__(self, num_prototypes, num_features, w_1, h_1,d_1):
        """
        Create a new L2Conv3D layer
        ...
        prototype_shape = (num_prototypes, num_features, w_1, h_1,d_1)
    ...
    def forward(self, xs):
        ...
        xs_squared_l2 = F.conv3d(xs ** 2, weight=ones)  # Shape: (bs, num_prototypes, w_in, h_in)
        ...
        ps_squared_l2 = torch.sum(self.prototype_vectors ** 2,
                                  dim=(1, 2, 3, 4))  # Shape: (num_prototypes,)
        ...
        xs_conv = F.conv3d(xs, weight=self.prototype_vectors)  # Shape: (bs, num_prototypes, w_in, h_in)

        # Use the values to compute the squared L2 distance
        # print(xs_squared_l2.shape)
        # print(ps_squared_l2.shape)
        # print(xs_conv.shape)

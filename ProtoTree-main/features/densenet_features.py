...
class _Transition(nn.Sequential):
    ...
    def __init__(self, num_input_features, num_output_features):
        ...
        self.add_module('pool', nn.AvgPool3d(kernel_size=2, stride=2)) # AvgPool3d has no padding
...
class DenseNet_features(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv3d(in_channels=3, out_channels=num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),

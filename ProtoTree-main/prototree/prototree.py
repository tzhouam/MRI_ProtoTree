...
from util.l2conv import L2Conv3D
...
class ProtoTree(nn.Module):
    ...
    def __init__(self,
        ...
        self.prototype_shape = (args.W1, args.H1, args.D1,args.num_features)
        ...
        self.prototype_layer = L2Conv3D(self.num_prototypes,
                                        self.num_features,
                                        args.W1,
                                        args.H1,
                                        args.D1)
    ...
    def forward(self,
        ...
        min_distances = min_pool2d(distances, kernel_size=(W, H,D))
        ...
        out,info=self.tree_forward(xs,sampling_strategy,**kwargs)
        return out,info
    def tree_forward(self,xs,sampling_strategy,**kwargs):
        '''
